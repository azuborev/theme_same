...
?>
    ...
    <section id="content">
        <div class="wrapper page_text">
            <h1 class="page_title"><?php _e( 'Gallery', 'same' ); ?></h1>
                    ...
                    <div class="page_gallery">
                        ...
                        while ( $wp_query->have_posts() ) {
                            ...
                            <div class="column column50">
                                <div class="image">
                                    <img src="<?php echo get_field('case_gallery_preview_photo')['url']; ?>" alt="<?php echo get_field('case_gallery_preview_photo')['alt']; ?>" />
                                    <p class="caption">
                                        <strong><?php the_field('case_photo_title'); ?></strong>
                                        <span><?php the_field('case_photo_caption_gallery'); ?></span>
                                        <a href="<?php echo get_field('case_main_photo')['url']; ?>" data-rel="prettyPhoto[gallery]" class="button button_small button_orange float_right lightbox"><span class="inside">zoom</span></a>
                                    </p>
                                </div>
                            </div>
                        <?php
